public class Main {
    ...
    public static int[] combine(int[] array1, int[] array2) {
        int[] stupid = new int[array1.length+array2.length];
        for (int i=0; i<array1.length; i++) {
            stupid[i] = array1[i];
        }
        for (int i=0; i<array2.length; i++) {
            stupid[i+array1.length] = array2[i];
        }
        return stupid;
    }
    ...
    public static int[] product(int[] array1, int[] array2) {
        int[] stupid = new int[array1.length];
        int rs = 0;
        for (int i = 0; i<array1.length; i++) {
            rs = array1[i]*array2[i];
            stupid[i] = rs;
        }
        return stupid;
    ...
    public static int[] capitalCount(String[] words) {
        int[] stupid = new int[words.length];
        for (int i=0; i<words.length; i++) {
            stupid [i] = countCapitalLetters(words[i]);
        }
        return stupid;
    }
